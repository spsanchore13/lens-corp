const About = () => {
  return (
    <div className="p-5 md:p-20">
      ...
      <div className="flex flex-col-reverse md:flex-col justify-between w-full bg-[#e2f2ff] mt-20 rounded-xl p-5 md:p-10 hover:scale-105 transition ease-in-out delay-150 duration-300">
        <div className="w-full flex flex-col justify-center items-center md:block md:w-[40%]">
          <h1 className="text-center text-4xl md:text-5xl text-bold mt-10">
            Welcome To LENS
          </h1>
          <p className="text-center my-2 md:my-10">
